...
// Voltage: flag only dangerous under-voltage; above-spec-but-working values use default text color.
    ...
    render: function(d) {
        ...
        return E('div', { 'id': 'rm520n-view' }, [
            ...
            E('div', { 'style': 'margin-top:4px' }, [
                E('button', { 'class': 'rm-btn rm-btn-default',
                    'click': function() { callRefresh().then(function(r) { updateSignal(r); }); }
                }, _('Refresh Now'))
            ]),
        ]);
    },
